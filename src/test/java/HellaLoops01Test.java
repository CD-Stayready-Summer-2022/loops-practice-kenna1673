...
public class HellaLoops01Test {
    ...
    public void testGetRange1A() {
        // : Given
        String expected = "012345678910"; // added 10 to match ReadMe example
        int stop = 11;
    ...
    public void testGetEvenNumbers() {
        // : Given
        String expected = "681012141618"; // odd numbers were here so swapped
        int start = 5;
        int stop = 20;
    ...
    public void testGetOddNumbers() {
        // : Given
        String expected = "5791113151719"; // even numbers were here so swapped
        int start = 5;
        int stop = 20;
        int step = 5;
